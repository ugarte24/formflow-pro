    ...
    <AppShell titulo="Administración" subtitulo="Usuarios e instalador" esAdmin={sesion?.esAdmin}>
      <section className="panel p-4">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          Descargá la última versión y pasásela al operador **solo la primera vez**.
          Después el agente se actualiza solo al iniciar (o con el botón Actualizar).
          El operador entra con el <strong>mismo email y contraseña</strong> de Digitalizador.
        </p>
