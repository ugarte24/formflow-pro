...
Al arrancar pedirá **email y contraseña** (las mismas de la web). Luego abre Firefox del agente **sin navegar**: usted abre `municipios.ruat.net`, inicia sesión, deja el **menú principal** visible y pulsa **Iniciar**. El agente verifica esa página y recién entonces procesa trámites.
